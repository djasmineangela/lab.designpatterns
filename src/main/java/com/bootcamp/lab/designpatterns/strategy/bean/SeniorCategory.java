...
@NoArgsConstructor
@AllArgsConstructor
public class SeniorCategory extends AbstractTicketCategory implements TicketCalculation{
	private static final BigDecimal CHILDREN_TICKET_PRICE = new BigDecimal(12);
